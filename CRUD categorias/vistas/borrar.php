    ...
    <body>
        <?php
            ...
            switch($resultado)
            {
                ...
                case 0:
                    echo '<div class="alert alert-danger my-3 mx-auto" style="width: 350px;">Error: La categoría a borrar ya no existe.</div>';
                    break;

                case 1: // Caso OK
                    echo '<div class="alert alert-success my-3 mx-auto" style="width: 350px;">Exito: La categoría ha sido eliminada.</div>';
                    break;
